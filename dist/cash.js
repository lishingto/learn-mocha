...
export const coins = [5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1];
/**
...
export const getChange = function (totalPayable, cashPaid) {
  'use strict';
  ...
  for (var i = 0; i < length; i++) {
    ...
    if (remaining / coin >= 1) {
      ...
      for (var j = 0; j < times; j++) {
        // add coin to change array x times
        change.push(coin);
